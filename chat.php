        ...
        <div class="all-chats">
            <div class="row">
                ...
                <div class="col-md-9 for-space-bw-col ps-0">
                    <div class="welcome_john">
                        <div class="img_welcome">
                            <span class="active_user"></span>
                            <img src="img/welcome1.png" class="img-fluid" alt="">
                        </div>
                        <div>
                            <p class="welcome">Welcome </p>
                            <p class="john_n">John Doe</p>
                        </div>
                    </div>
                    <div class="welcome_img2">
                        <img src="img/welcome2.png" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
