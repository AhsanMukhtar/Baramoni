...
<section class="paralax_scroll">
    ...
    <section class="shop_sec">
        <section class="section-head">
            <div class="head-page">
                <h3 class="heading-page">Detail</h3>
            </div>
        </section>
                    ...
                    <div class="col-lg-6 mt-4">
                        ...
                        <div class="availability-wrapper">
                            <span class="Availability">Availability :</span> &nbsp; &nbsp; &nbsp; <span
                                class="InStock">In Stock (13)</span>
                        </div>
                        ...
                        <div class="counter-and-price-wrapper">
                            <div class="price-wrapper">
                                <h2><span class="sales-price">$ 49.00</span> <strike class="regular-price">$
                                        59.00</strike> </h2>
                            </div>
                            <div class="number">
                    ...
                    <div class="col-md-8">
                        <div class="product-info">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                                ...
                                eiusmod tempor incididunt ut labore et dolore.Lorem ipsum dolor sit amet,Lorem ipsum
                                dolor sit amet</p>
                        </div>
                                    ...
                                    <div class="rev-wrapper">
                                        ...
                                        <form action="">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="email" class="form-control" placeholder="Rating">
                                            ...
                                            <div class="form-group">
                                                <textarea name="" class="form-control" placeholder="Type here" id=""
