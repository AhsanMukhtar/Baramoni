...
<section class="paralax_scroll">
    ...
    <section class="shop_sec">
        <section class="section-head">
            <div class="head-page">
                <h3 class="heading-page">Contact us</h3>
            </div>
        </section>
                    ...
                    <div class="col-md-8">
                        <div class="get-qoute">
                            ...
                            <p>If you require any further help or support, arrange a call back at a time that suits you.
                                ...
                                to speaking with you shortly.</p>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" placeholder="info@example.com">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                            placeholder="Give description here"></textarea>
                                    </div>
                                </div>
